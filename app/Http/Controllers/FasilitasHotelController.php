...
class FasilitasHotelController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'foto'=>'required|image|mimes:png,jpg,jpeg|dimensions:min_width=1000,min_height=500|between:50,5000',
        ...
        return redirect()->route('fasilitas.create')->with('status','store');
    }
    ...
    public function edit(FasilitasHotel $fasilita)
    {
        ...
        return view('fasilitas_hotel.edit',['item'=>$fasilita]);
    }
    ...
    public function update(Request $request, FasilitasHotel $fasilita)
    {
        $request->validate([
            'nama_fasilitas'=>'required|min:3',
            'foto'=>'nullable|image|mimes:png,jpg,jpeg|dimensions:min_width=1000,min_height=500|between:50,5000',
            'deskripsi'=>'required|min:10'
        ]);
